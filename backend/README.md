...
## Project Structure
    ...
    ├── testapiautocatalog_114404  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_114404`
...
2. Clone this repo and `cd testapiautocatalog_114404`
